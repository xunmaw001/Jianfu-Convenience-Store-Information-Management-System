	            ...
	            <div class="row">
	              ...
	              <div class="col-md-12">
	                ...
	                <div class="widget-head">
	                  <div class="pull-left">聊天回复列表</div>
								...
								<th><input type="checkbox" onclick="chooseAll()"/></th>
																											<th onclick="sort('biaoti')">标题<i id="biaotiIcon" class="fa fa-sort"></i></th>
																																				<th onclick="sort('gonghao')">工号<i id="gonghaoIcon" class="fa fa-sort"></i></th>
																																															<th style="min-width: 100px;">聊天回复</th>
																				
																																				<th onclick="sort('huifuriqi')">回复日期<i id="huifuriqiIcon" class="fa fa-sort"></i></th>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
		...
		function setDataRow(item){
			...
			row.appendChild(chkTd);
            				...
            				var liaotianhuifuCell  = document.createElement('td');

												  if(item.liaotianhuifu !=null && item.liaotianhuifu != "" && item.liaotianhuifu.length >= 11){
				  	liaotianhuifuCell.innerHTML = item.liaotianhuifu.substring(0, 10) + "..."; 
				  }else{
				  	liaotianhuifuCell.innerHTML = item.liaotianhuifu;
				  }

				
									row.appendChild(liaotianhuifuCell);
				
            				var huifuriqiCell  = document.createElement('td');

												  huifuriqiCell.innerHTML = item.huifuriqi; 
				  
                
									row.appendChild(huifuriqiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("liaotianhuifu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'liaotianhuifu/page';
		...
		function datePick(){
			$.fn.datetimepicker.dates['zh-CN'] = { 
		            ...
		            meridiem: ["上午", "下午"]
																																	...
																																	$(function() { 
						$('#huifuriqi_start').datetimepicker({ 
						pickTime: false,
						language:'zh-CN'
						});
					});
					$(function() { 
						$('#huifuriqi_end').datetimepicker({ 
						pickTime: false,
						language:'zh-CN'
						});
					});
		...
		function getSum(colName){
			...
			window.sessionStorage.setItem('crossTableName',"liaotianhuifu");
