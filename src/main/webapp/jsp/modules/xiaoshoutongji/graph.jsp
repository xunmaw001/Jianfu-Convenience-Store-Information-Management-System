	              ...
	              <div class="col-md-12">
	                ...
	                <div class="widget">
	            		...
	            		<!--<div id="main" style="width: 600px;height:400px;"></div>-->
																																																																		<div id="gonghaoMain" class="graph" style="width: 900px;height:600px;"></div>
													                </div>
	              </div>
	            </div>
	        </div>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
	 ...
	 <script type="text/javascript">
		...
		var pageType = "graph";
														...
														var yColumnName = 'yingyezonge';
		var yColumnCnName = '营业总额';
												var xColumnName = 'gonghao';
		var gonghaoValArr = [];
		var gonghaoNameArr = [];
		var gonghaoMapList = [];
		...
		// 需要调group的字段，一个字段一个统计图
																						function gonghaoDraw(){
			// 基于准备好的dom，初始化echarts实例
			var myChart = echarts.init(document.getElementById('gonghaoMain'),'macarons');
		...
		function dataBindByValue(list){
						...
						gonghaoNameArr.push(list[i].gonghao);
						gonghaoValArr.push(list[i].total);
					}
								gonghaoDraw();
								}
