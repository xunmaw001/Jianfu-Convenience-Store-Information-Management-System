	    ...
	    <%@ include file="../../static/sidebar.jsp"%>
	  	...
	  	<div class="mainbar">
	        ...
	        <div class="bread-crumb pull-right">
	          ...
	          <a href="#" class="bread-current">管理员表</a>
	        </div>
						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input type="hidden" name="id" v-model="ruleForm.id">
																			...
																			<input id="username"  v-model="ruleForm.username" readonly>
																				...
																				<div class="col-lg-6">
																			<input id="password"  v-model="ruleForm.password" readonly>
																			</div>
									</div>
																																<div class="form-group">
																				<label class="control-label col-lg-3">角色名称</label>
																				<div class="col-lg-6">
																			<input id="role"  v-model="ruleForm.role" readonly>
																			</div>
									</div>
