  ...
  <body>
		...
		<%@ include file="../../static/sidebar.jsp"%>
	      ...
	      <div class="page-head">
	        ...
	        <div class="bread-crumb pull-right">
	          ...
	          <a href="#" class="bread-current">供应商</a>
	        </div>
	                    ...
	                    <a href="#" class="wclose"><i class="icon-remove"></i></a>-->
						  <form class="navbar-form navbar-left" id="searchForm" name="searchForm" role="search" style="margin: 3px 0 3px 0; white-space: nowrap;" onsubmit="saveSearchForm()">
							  <div class="form-group" id="form-item-group">
								 																			<label>账号</label>
																					<input name="zhanghao" placeholder="账号">
																			                                 									                                 																			<label>公司名称</label>
																					<input name="gongsimingcheng" placeholder="公司名称">
																			                                 									                                 									                                 									                                 							  </div>
						  </form>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'gongyingshang/page';
		...
		function saveSearchForm() {
			searchForm = { key: ""};
			pageIndex = 1;
																		var zhanghao = document.forms["searchForm"]["zhanghao"].value;
						if(zhanghao != null && zhanghao.trim() != ""){
							searchForm.zhanghao = "%" + zhanghao + "%"
						}
									 
																													var gongsimingcheng = document.forms["searchForm"]["gongsimingcheng"].value;
						if(gongsimingcheng != null && gongsimingcheng.trim() != ""){
							searchForm.gongsimingcheng = "%" + gongsimingcheng + "%"
						}
