	              ...
	              <div class="widget-content">
	                <div class="padd">
	                  ...
	                  <form id="registerForm" class="form-horizontal" action="" method="post">
								...
								<div class="col-lg-9">
									<input type="text" name="zhanghao" class="form-control" placeholder="账号">
								</div>
								</div>
																			  									<div class="form-group">
								<label class="control-label col-lg-3">密码</label>
								<div class="col-lg-9">
									<input type="text" name="mima" class="form-control" placeholder="密码">
								</div>
								</div>
																			  									<div class="form-group">
								<label class="control-label col-lg-3">公司名称</label>
								<div class="col-lg-9">
									<input type="text" name="gongsimingcheng" class="form-control" placeholder="公司名称">
								</div>
								</div>
																			  									<div class="form-group">
								<label class="control-label col-lg-3">负责人</label>
								<div class="col-lg-9">
									<input type="text" name="fuzeren" class="form-control" placeholder="负责人">
								</div>
								</div>
																			  									<div class="form-group">
								<label class="control-label col-lg-3">电话</label>
								<div class="col-lg-9">
									<input type="text" name="dianhua" class="form-control" placeholder="电话">
								</div>
								</div>
																			  									<div class="form-group">
								<label class="control-label col-lg-3">地址</label>
								<div class="col-lg-9">
									<input type="text" name="dizhi" class="form-control" placeholder="地址">
								</div>
								</div>
