						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input type="hidden" name="id" v-model="ruleForm.id">
																			...
																			<input id="gongsimingcheng"  v-model="ruleForm.gongsimingcheng" readonly>
																				...
																				<div class="col-lg-6">
																			<input id="fuzeren"  v-model="ruleForm.fuzeren" readonly>
																			</div>
									</div>
																																<div class="form-group">
																				<label class="control-label col-lg-3">电话</label>
																				<div class="col-lg-6">
																			<input id="dianhua"  v-model="ruleForm.dianhua" readonly>
																			</div>
									</div>
																																<div class="form-group">
																				<label class="control-label col-lg-3">地址</label>
																				<div class="col-lg-6">
																			<input id="dizhi"  v-model="ruleForm.dizhi" readonly>
																			</div>
									</div>
