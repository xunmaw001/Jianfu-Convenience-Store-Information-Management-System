  ...
  <body>
						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input id="updateId" name="id" type="hidden">
										...
										<div class="col-lg-6">
											...
											<div class="form-group">
										<label class="control-label col-lg-3">投诉内容</label>
										<div class="col-lg-6">
											<textarea id="tousuneirong" name="tousuneirong" class="form-control" rows="3" placeholder="投诉内容"></textarea>
										</div>
									</div>
											<div class="form-group">
										<label class="control-label col-lg-3">投诉日期</label>
										<div class="col-lg-6">	
											<div id="tousuriqi" class="input-append">
												<input id="tousuriqi-input" name="tousuriqi" data-format="yyyy-MM-dd" type="text" class="form-control dtpicker" style="max-width: 95px;">
												<span class="add-on">
	...
	<script type="text/javascript">
		...
		function submit() {
				...
				httpJson("tousuxinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
																																																																																										if(flag){
							alert(successMes);
						}
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#biaoti").val(ruleForm.biaoti);	
																$("#tousuneirong-input").val(ruleForm.tousuneirong);
																$("#tousuriqi-input").val(ruleForm.tousuriqi);
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.tousuneirong != null && res.data.tousuneirong != ''){
															...
															$("#tousuneirong-input").val(res.data.tousuneirong);
													}
												if(res.data != null && res.data != '' && res.data.tousuriqi != null && res.data.tousuriqi != ''){

															$("#tousuriqi-input").val(res.data.tousuriqi);
								$('#tousuriqiFileName').val(res.data.tousuriqi)
													}
