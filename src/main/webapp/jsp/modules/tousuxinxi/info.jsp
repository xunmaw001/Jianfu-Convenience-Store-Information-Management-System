						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input type="hidden" name="id" v-model="ruleForm.id">
																			...
																			<input id="biaoti"  v-model="ruleForm.biaoti" readonly>
																				...
																				<div class="col-lg-6">
																			<input id="tousuriqi"  v-model="ruleForm.tousuriqi" readonly>
																			</div>
									</div>
																																<div class="form-group">
											...
											<div class="col-lg-6">
												...
												<input type="hidden" id="tousuneirong-input">
											</div>
										</div>
																																																																																																																																																			<div class="form-group">
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "tousuxinxi/info/" + id,
