  ...
  <body>
		...
		<%@ include file="../../static/sidebar.jsp"%>
	      ...
	      <div class="page-head">
	        ...
	        <div class="bread-crumb pull-right">
	          ...
	          <a href="#" class="bread-current">员工</a>
	        </div>
	                    ...
	                    <a href="#" class="wclose"><i class="icon-remove"></i></a>-->
						  <form class="navbar-form navbar-left" id="searchForm" name="searchForm" role="search" style="margin: 3px 0 3px 0; white-space: nowrap;" onsubmit="saveSearchForm()">
							  <div class="form-group" id="form-item-group">
								 																			<label>工号</label>
																					<input name="gonghao" placeholder="工号">
																			                                 									                                 																			<label>姓名</label>
																					<input name="xingming" placeholder="姓名">
																			                                 																			<label>性别</label>
																					<select name="xingbie">
																							<option value=" "></option>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
		...
		function saveSearchForm() {
			searchForm = { key: ""};
			pageIndex = 1;
																		var gonghao = document.forms["searchForm"]["gonghao"].value;
						if(gonghao != null && gonghao.trim() != ""){
							searchForm.gonghao = "%" + gonghao + "%"
						}
									 
																													var xingming = document.forms["searchForm"]["xingming"].value;
						if(xingming != null && xingming.trim() != ""){
							searchForm.xingming = "%" + xingming + "%"
						}
									 
																						var xingbie = document.forms["searchForm"]["xingbie"].value;
						if(xingbie != null && xingbie.trim() != ""){
							searchForm.xingbie = "%" + xingbie + "%"
						}
