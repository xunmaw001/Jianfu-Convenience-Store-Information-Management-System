	                  ...
	                  <div class="padd">
						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input id="updateId" name="id" type="hidden">
										...
										<div class="col-lg-6">
											<select id="xingbieSelect" name="xingbie">
																							<option class="xingbieOption" value=" "></option>
										...
										<div class="col-lg-6">
											<input id="shenfenzheng" name="shenfenzheng" placeholder="身份证">
										</div>
									</div>	
											<div class="form-group">
										<label class="control-label col-lg-3">手机</label>
										<div class="col-lg-6">
											<input id="shouji" name="shouji" placeholder="手机">
										</div>
									</div>	
