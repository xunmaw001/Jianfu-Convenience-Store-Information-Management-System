	            ...
	            <div class="row">
	              ...
	              <div class="col-md-12">
	                ...
	                <div class="widget-head">
	                  <div class="pull-left">聊天信息列表</div>
	                        ...
	                        <tr>
								<th><input type="checkbox" onclick="chooseAll()"/></th>
																											<th onclick="sort('biaoti')">标题<i id="biaotiIcon" class="fa fa-sort"></i></th>
																																															<th style="min-width: 100px;">聊天内容</th>
	...
	<span class="totop"><a href="#"><i class="icon-chevron-up"></i></a></span> 
		...
		function setDataRow(item){
			...
			row.appendChild(chkTd);
            				...
            				var liaotianneirongCell  = document.createElement('td');

												  if(item.liaotianneirong !=null && item.liaotianneirong != "" && item.liaotianneirong.length >= 11){
				  	liaotianneirongCell.innerHTML = item.liaotianneirong.substring(0, 10) + "..."; 
				  }else{
				  	liaotianneirongCell.innerHTML = item.liaotianneirong;
				  }

				
									row.appendChild(liaotianneirongCell);
			...
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"liaotianhuifu\")");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("liaotianxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function setSearchForm() {
			//设置查询表单的url
			var url = baseUrl + 'liaotianxinxi/page';
		...
		function datePick(){
			$.fn.datetimepicker.dates['zh-CN'] = { 
		            ...
		            meridiem: ["上午", "下午"]
																										...
																										$(function() { 
						$('#riqi_start').datetimepicker({ 
						pickTime: false,
						language:'zh-CN'
						});
					});
					$(function() { 
						$('#riqi_end').datetimepicker({ 
						pickTime: false,
						language:'zh-CN'
						});
					});
		...
		function getSum(colName){
			...
			window.sessionStorage.setItem('crossTableName',"liaotianxinxi");
