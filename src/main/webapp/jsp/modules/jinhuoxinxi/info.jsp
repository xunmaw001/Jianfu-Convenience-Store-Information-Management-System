	                  ...
	                  <div class="padd">
						...
						<form class="form-horizontal" id="addOrUpdateForm" method="post">
							<input type="hidden" name="id" v-model="ruleForm.id">
																				...
																				<div class="col-lg-6">
																			<input id="dingdanbianhao"  v-model="ruleForm.dingdanbianhao" readonly>
																			</div>
									</div>
																																<div class="form-group">
																			...
																			<input id="shuliang"  v-model="ruleForm.shuliang" readonly>
																				...
																				<div class="col-lg-6">
																			<input id="zongjiage"  v-model="ruleForm.zongjiage" readonly>
																			</div>
									</div>
																																<div class="form-group">
																				<label class="control-label col-lg-3">进货日期</label>
																				<div class="col-lg-6">
																			<input id="jinhuoriqi"  v-model="ruleForm.jinhuoriqi" readonly>
																			</div>
									</div>
																																<div class="form-group">
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jinhuoxinxi/info/" + id,
